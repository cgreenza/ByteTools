...
namespace ByteTools.Encodings
{
    ...
    {
        private static readonly ushort[] _byteToCharPairLookup = {
        ...
        private static readonly ushort[] _charToNibbleLookup = {
            ...
            0xFFFF, 0x000A, 0x000B, 0x000C, 0x000D, 0x000E, 0x000F, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF,
            0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF,
            0xFFFF, 0x000A, 0x000B, 0x000C, 0x000D, 0x000E, 0x000F, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF,
            0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF,
            0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF,
        ...
        public static string GetString(byte[] sourceBytes)
        {
            ...
            {
                var characterPair = _byteToCharPairLookup[sourceBytes[i]];
                outputChars[2 * i] = (char)(characterPair & 0xFF);
                outputChars[2 * i + 1] = (char)(characterPair >> 8);
            }
        ...
        public static byte[] GetBytes(string sourceString)
        {
            ...
            var outputLength = sourceString.Length / 2;
            var outputBytes = new byte[outputLength];

            try
            {
                for (int i = 0; i < outputLength; i++)
                    outputBytes[i] = checked((byte)(
                        _charToNibbleLookup[(byte)sourceString[i * 2]] << 4 |
                        _charToNibbleLookup[(byte)sourceString[i * 2 + 1]]));
            }
            catch (OverflowException) // invalid characters will not fit within a byte and will be detected by the checked logic
            {
                throw new FormatException("The input is not a valid hex string as it contains at least one non-hex character");
            }
